Shader "Unlit/UnlitPlanShader"
{
	Properties
	{
		...
		_FogNoiseScale("Fog Scale", float) = (1, 1, 1, 1) 
		_FogMovementDirection("Movement Direction Fog", float) = (0, -1, 0, 1)
		...
		SubShader
		{
			...
			Pass
			{
				...
				float3 _FogMovementDirection;
				float3 _MainMovementDirection;
				half2 _IgnoreNormal;
				...
				fixed4 frag(v2f v) : SV_Target
				{
					...
					value = value + _NoiseMovementDirection * _Time.y;
